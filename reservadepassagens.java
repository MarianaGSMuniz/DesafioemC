...
//var global
    static Scanner leia = new Scanner(System.in);
        static String empAerea[] = new String[3]; 
    static String codVoo[] = new String[3]; 
    static String RG[] = new String[4]; 
    static int dispL[] = new int[3]; 
    static boolean vaz[] = new boolean[3]; 
